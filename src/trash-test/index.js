...
const cv ="<h2 class='content-head'>" + "Expériences professionelles" + "</h2>" + "<div class='job-section-container'>" +
...
const competences = `
<h2 class="content-head">Compétences</h2>
</div>
...
const outils = `<h2 class="content-head">Mes outils</h2>
<div class="job-section-container">
