export const contentData = [
    ...
    content: `<h2 class="content-head">A propos de moi</h2>
            ...
            <p>Passioné d'informatique depuis mon plus jeune âge, je souhaite mettre à profit mes compétences fraîchement acquises, ma curiosité et ma forte créativité afin de développeeeeer des applications visuellement attrayantes et ergonomiques pour les utilisateurs.</p>
    ...
    <ul class="job-desc">
        ...
        <li>Utiliser les mediaqueries pour adapter l'application sur tous support</li>
...
<p class="exp-title">Divers et loisir :</p>
    ...
    <p class="exp-title">Par email : <a href="huguet.mathieu@gmail.com">huguet.mathieu@gmail.com</a></p>
    <p class="exp-title">Sur Linkedin : <a href="https://www.linkedin.com/in/mathieu-huguet-b954371b9/" target="_blank" rel="noreferrer"><img class="icon" src="./src/img/icons8-linkedin-bw-96.png" alt="lien linkedin"/>
</a></p>
